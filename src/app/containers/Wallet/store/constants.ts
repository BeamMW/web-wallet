export enum WalletActionTypes {
  ...
  SET_ADDRESS_UD = '@@WALLET/SET_ADDRESS_UD',
  ...
  GET_ASSET_INFO = '@@WALLET/GET_ASSET_INFO',
  GET_ASSET_INFO_SUCCESS = '@@WALLET/GET_ASSET_INFO_SUCCESS',
  GET_ASSET_INFO_FAILURE = '@@WALLET/GET_ASSET_INFO_FAILURE',

  GET_ASSET_LIST = '@@WALLET/GET_ASSET_LIST',
  GET_ASSET_LIST_SUCCESS = '@@WALLET/GET_ASSET_LIST_SUCCESS',
  GET_ASSET_LIST_FAILURE = '@@WALLET/GET_ASSET_LIST_FAILURE',
}
